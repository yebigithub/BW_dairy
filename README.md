...
## 2. Mask RCNN method
### 2.1 LabelMe.
- The code was forked from https://github.com/wkentaro/labelme and revised following https://github.com/uf-aiaos/ShinyAnimalCV
...
```
![alt text](https://github.com/yebigithub/BW_dairy/blob/main/python/mrcnn/LabelMe/HowToLabelMe1.gif)
...
![alt text](https://github.com/yebigithub/BW_dairy/blob/main/python/mrcnn/mrcnn.gif)

#### 2.2.2 Predict depth images by trained Mask-RCNN model.
- [.py file](https://github.com/yebigithub/BW_dairy/blob/main/python/mrcnn/ImageAnalysis_mrcnn.py)
